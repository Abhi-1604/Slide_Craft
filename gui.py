...
def gui(answer):
    def generate(result):
        ...
        if template_option.get()==1:
            ...
            template_selected = 4
        elif template_option.get()==5:
            template_selected = 5
        elif template_option.get()==6:
            template_selected = 6
        elif template_option.get()==7:
            template_selected = 7
        elif template_option.get()==8:
            template_selected = 8
        elif template_option.get()==9:
            template_selected = 9
        elif template_option.get()==10:
            template_selected = 10
        elif template_option.get()==11:
            template_selected = 11
        elif template_option.get()==12:
            template_selected = 12
        elif template_option.get()==13:
            template_selected = 13
        elif template_option.get()==14:
            template_selected = 14
        elif template_option.get()==15:
            template_selected = 15
        elif template_option.get()==16:
            template_selected = 16
        elif template_option.get()==17:
            template_selected = 17
        elif template_option.get()==18:
            template_selected = 18
        elif template_option.get()==19:
            template_selected = 19
        elif template_option.get()==20:
            template_selected = 20
        elif template_option.get()==21:
            template_selected = 21
        elif template_option.get()==22:
            template_selected = 22
        if option.get()==1:
            choice = 1
            window.destroy()
