...
def create_slides_professional_business(gpt_response, slide_title, slide_number, Topic, choice, pic):
    prs = Presentation()
    #Topic Slide
    topic = prs.slides.add_slide(prs.slide_layouts[5])
    background = topic.shapes.add_picture("Templates\Professional_Business\Professional_Business_Title_Slide.png", 0, 0, prs.slide_width, prs.slide_height)
    #Topic Title
    t_title = topic.shapes.add_textbox(Pt(235), Pt(170), Pt(250), Pt(180))
    tf1 = t_title.text_frame
    t_title.text = Topic
    tf1.paragraphs[0].font.color.rgb = RGBColor(102, 51, 0)
    ...
    ctf1.paragraphs[0].font.color.rgb = RGBColor(102, 51, 0)
    ...
    for i in range(slide_number):
        ...
        if count<no_of_pic:
            if i%2==0:
                background = slide.shapes.add_picture("Templates\Professional_Business\Professional_Business_Slide_"+str(i+1)+".png", 0, 0, prs.slide_width, prs.slide_height)
                ...
                ctf2.paragraphs[0].font.color.rgb = RGBColor(102, 51, 0)
                ctf2.paragraphs[0].font.size = Pt(24)
                ctf2.paragraphs[0].alignment = PP_ALIGN.CENTER
                ctf2.word_wrap = True
                print("\n\nSlide done\n\n")
            else:
                count = count + 1
                background = slide.shapes.add_picture("Templates\Professional_Business\Professional_Business_Slide_"+str(count)+".png", 0, 0, prs.slide_width, prs.slide_height)
        ...
        tf2.paragraphs[0].font.color.rgb = RGBColor(102, 51, 0)
