...
def create_slides_company(gpt_response, slide_title, slide_number, Topic, choice, pic):
    prs = Presentation()
    #Topic Slide
    topic = prs.slides.add_slide(prs.slide_layouts[5])
    background = topic.shapes.add_picture("Templates\Company\Company_Presentation_Title_Slide.png", 0, 0, prs.slide_width, prs.slide_height)
    #Topic Title
    ...
    for i in range(slide_number):
        ...
        if count<no_of_pic:
            if i%2==0:
                background = slide.shapes.add_picture("Templates\Company\Company_Presentation_Slide_"+str(i+1)+".png", 0, 0, prs.slide_width, prs.slide_height)
                ...
                count = count + 1
                background = slide.shapes.add_picture("Templates\Company\Company_Presentation_Slide_"+str(count)+".png", 0, 0, prs.slide_width, prs.slide_height)
